...
\mynames{Li\bibnamedelima Yue,
  Li \bibnamedelima Yue,
  Li/Yue,
  Li/Y,
  Li/Y.,
  Li/L.\bibnamedelimi Y.}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Yue Li, Ph.D. Candidate.}
  
  Department of Bridge Engineering, Tongji University, China
  
  Institute of Mechanics of Materials and Structures (imws), TU Wien, Austria 
  
  \makefield{\faEnvelope[regular]}{\href{mailto:yue.li@tuwien.ac.at}{\texttt{yue.li@tuwien.ac.at}}}
  \makefield{\faPhone[regular]}{\href{}{\texttt{+42067764886521}}}
  % \makefield{\faTwitter}{\href{https://twitter.com/overleaf_example}{\texttt{@overleaf\_example}}}
  
  \makefield{\faResearchgate}{\href{https://www.researchgate.net/profile/Yue-Li-95}{\texttt{http://www.researchgate.net/profile/Yue-Li-95}}}
